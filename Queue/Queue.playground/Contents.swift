/*
 ...
 A queue is a list where you can only isert new items at the back and remove items from the front and removes items from the front. This ensures that the first item you enqueue is also the first item you dequeue. First come, first serve.
...
// Returns "Lisa" since "Carl" was dequeued on the pervious line.
queueOfNames.front

// Check to see if the queue is empty.
// Returns "false" since the queue still has element in it.
